...
import './HomePage.css';
import logo from '../assets/images/Photos/ProfilAlexandre.png';
                  ...
                  <h2 className='h2-responsive mb-4'>
                    <strong className='font-weight-bold'>
                      <img 
                        ...
                        className='pr-2 w-25'
                      />
                      Alexandre LEURIDAN-PARROUY
                    </strong>
                  </h2>
                  <hr className='my-5' />
                  <MDBRow />
                  <h4 className="font-weight-bold" >Ingénieur Technologie de l'Information</h4>
                  <p className='pb-4'>
                    Innover, développer de nouveaux outils, optimiser et performer ont été les maîtres mots de mes expériences. Avide de savoir technologique, je me sens armé pour relever de nouveaux défis.
                  </p>
